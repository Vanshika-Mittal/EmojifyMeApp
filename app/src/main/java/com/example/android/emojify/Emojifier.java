...
class Emojifier {
    ...
    static Bitmap detectFacesAndOverlayEmoji(Context context, Bitmap picture) {
        ...
        //  (3): Change the name of the detectFaces() method to detectFacesAndOverlayEmoji() and the return type from void to Bitmap
        ...
        //  (7): Create a variable called resultBitmap and initialize it to the original picture bitmap passed into the detectFacesAndOverlayEmoji() method
        ...
        if(faces.size() == 0) {
            ...
            for (int i = 0; i < faces.size(); ++i) {
                ...
                //  (4): Create a variable called emojiBitmap to hold the appropriate Emoji bitmap and remove the call to whichEmoji()
                ...
                //  (8): Call addBitmapToFace(), passing in the resultBitmap, the emojiBitmap and the Face  object, and assigning the result to resultBitmap
    ...
    private static Emoji whichEmoji(Face face) {
        ...
        //  (1): Change the return type of the whichEmoji() method from void to Emoji.
        ...
        //  (2): Have the method return the selected Emoji type.
        return emoji;
    }

    // TODO (6) Create a method called addBitmapToFace() which takes the background bitmap, the Emoji bitmap,
    // and a Face object as arguments and returns the combined bitmap with the Emoji over the face.
